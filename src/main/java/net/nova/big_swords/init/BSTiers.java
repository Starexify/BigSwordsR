...
public class BSTiers {
    public static final Tier PATCHWORK = new SimpleTier(BlockTags.INCORRECT_FOR_STONE_TOOL, 30, 1.0F, -1.5F, 16, () -> Ingredient.of(Items.ROTTEN_FLESH));
    public static final Tier SKULL = new SimpleTier(BlockTags.INCORRECT_FOR_STONE_TOOL, 103, 2.0F, -0.5F, 13, () -> Ingredient.of(Items.BONE));
    ...
    public static final Tier REAPER = new SimpleTier(BlockTags.INCORRECT_FOR_STONE_TOOL, 206, 2.0F, -0.5F, 18, () -> Ingredient.of(Items.BONE));
}
