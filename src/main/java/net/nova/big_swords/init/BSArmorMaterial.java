...
public interface BSArmorMaterial {
    ArmorMaterial LIVINGMETAL = new ArmorMaterial(29, Util.make(new EnumMap<>(ArmorType.class), map -> {
    ...
    ArmorMaterial BIOMASS = new ArmorMaterial(29, Util.make(new EnumMap<>(ArmorType.class), map -> {
