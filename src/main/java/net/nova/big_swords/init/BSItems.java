...
public class BSItems {
    ...
    public static RegistryObject<Item> LIVINGMETAL_SWORD = ITEMS.register("livingmetal_sword", () -> new SwordItem(BSTiersV.LIVINGMETAL, 3, -2.4F, new Item.Properties()));
    public static RegistryObject<Item> LIVINGMETAL_PICKAXE = ITEMS.register("livingmetal_pickaxe", () -> new PickaxeItem(BSTiersV.LIVINGMETAL, 1, -2.8F, new Item.Properties()));
    public static RegistryObject<Item> LIVINGMETAL_AXE = ITEMS.register("livingmetal_axe", () -> new AxeItem(BSTiersV.LIVINGMETAL, 6.0F, -3.0F, new Item.Properties()));
    public static RegistryObject<Item> LIVINGMETAL_SHOVEL = ITEMS.register("livingmetal_shovel", () -> new ShovelItem(BSTiersV.LIVINGMETAL, 1.5F, -3.0F, new Item.Properties()));
    public static RegistryObject<Item> LIVINGMETAL_HOE = ITEMS.register("livingmetal_hoe", () -> new BSHoeItem(BSTiersV.LIVINGMETAL, -2.5F, -0.5F, new Item.Properties()));
    ...
    public static RegistryObject<Item> BIOMASS_SWORD = ITEMS.register("biomass_sword", () -> new SwordItem(BSTiersV.BIOMASS, 3, -2.4F, new Item.Properties()));
    public static RegistryObject<Item> BIOMASS_PICKAXE = ITEMS.register("biomass_pickaxe", () -> new PickaxeItem(BSTiersV.BIOMASS, 1, -2.8F, new Item.Properties()));
    public static RegistryObject<Item> BIOMASS_AXE = ITEMS.register("biomass_axe", () -> new AxeItem(BSTiersV.BIOMASS, 6.0F, -3.0F, new Item.Properties()));
    public static RegistryObject<Item> BIOMASS_SHOVEL = ITEMS.register("biomass_shovel", () -> new ShovelItem(BSTiersV.BIOMASS, 1.5F, -3.0F, new Item.Properties()));
    public static RegistryObject<Item> BIOMASS_HOE = ITEMS.register("biomass_hoe", () -> new HoeItem(BSTiersV.BIOMASS, -2, -0.5F, new Item.Properties()));
    ...
    public static RegistryObject<Item> LIVINGMETAL_BIG_SWORD = ITEMS.register("livingmetal_big_sword", () -> new BigSwordItem(BSTiersV.LIVINGMETAL, 6.5F, -2.8F, new Item.Properties()));
    public static RegistryObject<Item> BIOMASS_BIG_SWORD = ITEMS.register("biomass_big_sword", () -> new BigSwordItem(BSTiersV.BIOMASS, 6.5F, -2.8F, new Item.Properties()));
    ...
    public static RegistryObject<Item> BIOMASS_SCYTHE = ITEMS.register("biomass_scythe", () -> new ScytheItem(BSTiersV.BIOMASS, 1, -2.0F, new Item.Properties(), 3F, 3.5F));
    public static RegistryObject<Item> LIVINGMETAL_SCYTHE = ITEMS.register("livingmetal_scythe", () -> new ScytheItem(BSTiersV.LIVINGMETAL, 1, -2.0F, new Item.Properties(), 3.5F, 4.5F));
    ...
    public static RegistryObject<Item> BIOMASS_SHIELD = ITEMS.register("biomass_shield", () -> new TieredShield(BSTiersV.BIOMASS, new Item.Properties(), 1, BSTiersV.BIOMASS.getUses() / 2));
    public static RegistryObject<Item> GILDED_BIOMASS_SHIELD = ITEMS.register("gilded_biomass_shield", () -> new TieredShield(BSTiersV.BIOMASS, new Item.Properties(), 2));
    public static RegistryObject<Item> LIVINGMETAL_SHIELD = ITEMS.register("livingmetal_shield", () -> new TieredShield(BSTiersV.LIVINGMETAL, new Item.Properties(), 1));
    public static RegistryObject<Item> GILDED_LIVINGMETAL_SHIELD = ITEMS.register("gilded_livingmetal_shield", () -> new TieredShield(BSTiersV.LIVINGMETAL, new Item.Properties(), 2, BSTiersV.LIVINGMETAL.getUses() / 2));
}
