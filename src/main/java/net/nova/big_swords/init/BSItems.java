...
public class BSItems {
    ...
    public static DeferredItem<Item> LIVINGMETAL_HOE = ITEMS.register("livingmetal_hoe", () -> new HoeItem(BSTiers.LIVINGMETAL, new Item.Properties().attributes(HoeItem.createAttributes(BSTiers.LIVINGMETAL, -2.5F, 0.0F))));
    ...
    public static DeferredItem<Item> BIOMASS_HOE = ITEMS.register("biomass_hoe", () -> new HoeItem(BSTiers.BIOMASS, new Item.Properties().attributes(HoeItem.createAttributes(BSTiers.BIOMASS, -2.0F, -0.5F))));

    // Big Swords
    public static DeferredItem<Item> WOODEN_BIG_SWORD = ITEMS.register("wooden_big_sword", () -> new BigSwordItem(Tiers.WOOD, new Item.Properties().attributes(BigSwordItem.createAttributes(Tiers.WOOD, 6.5F, -2.8F))));
    public static DeferredItem<Item> STONE_BIG_SWORD = ITEMS.register("stone_big_sword", () -> new BigSwordItem(Tiers.STONE, new Item.Properties().attributes(BigSwordItem.createAttributes(Tiers.STONE, 6.5F, -2.8F))));
    public static DeferredItem<Item> IRON_BIG_SWORD = ITEMS.register("iron_big_sword", () -> new BigSwordItem(Tiers.IRON, new Item.Properties().attributes(BigSwordItem.createAttributes(Tiers.IRON, 6.5F, -2.8F))));
    public static DeferredItem<Item> GOLDEN_BIG_SWORD = ITEMS.register("golden_big_sword", () -> new BigSwordItem(Tiers.GOLD, new Item.Properties().attributes(BigSwordItem.createAttributes(Tiers.GOLD, 6.5F, -2.8F))));
    public static DeferredItem<Item> DIAMOND_BIG_SWORD = ITEMS.register("diamond_big_sword", () -> new BigSwordItem(Tiers.DIAMOND, new Item.Properties().attributes(BigSwordItem.createAttributes(Tiers.DIAMOND, 6.5F, -2.8F))));
    public static DeferredItem<Item> NETHERITE_BIG_SWORD = ITEMS.register("netherite_big_sword", () -> new BigSwordItem(Tiers.NETHERITE, new Item.Properties().attributes(BigSwordItem.createAttributes(Tiers.NETHERITE, 6.5F, -2.8F)).fireResistant()));
    public static DeferredItem<Item> PATCHWORK_BIG_SWORD = ITEMS.register("patchwork_big_sword", () -> new BigSwordItem(BSTiers.PATCHWORK, new Item.Properties().attributes(BigSwordItem.createAttributes(BSTiers.PATCHWORK, 6.5F, -2.8F))));
    public static DeferredItem<Item> SKULL_BIG_SWORD = ITEMS.register("skull_big_sword", () -> new BigSwordItem(BSTiers.SKULL, new Item.Properties().attributes(BigSwordItem.createAttributes(BSTiers.SKULL, 6.5F, -2.8F))));
    public static DeferredItem<Item> QUARTZ_BIG_SWORD = ITEMS.register("quartz_big_sword", () -> new BigSwordItem(BSTiers.QUARTZ, new Item.Properties().attributes(BigSwordItem.createAttributes(BSTiers.QUARTZ, 6.5F, -2.8F))));
    public static DeferredItem<Item> OBSIDIAN_BIG_SWORD = ITEMS.register("obsidian_big_sword", () -> new BigSwordItem(BSTiers.OBSIDIAN, new Item.Properties().attributes(BigSwordItem.createAttributes(BSTiers.OBSIDIAN, 6.5F, -2.8F))));
    public static DeferredItem<Item> ENDER_BIG_SWORD = ITEMS.register("ender_big_sword", () -> new BigSwordItem(BSTiers.ENDER, new Item.Properties().attributes(BigSwordItem.createAttributes(BSTiers.ENDER, 6.5F, -2.8F)).fireResistant()));
    public static DeferredItem<Item> LIVINGMETAL_BIG_SWORD = ITEMS.register("livingmetal_big_sword", () -> new BigSwordItem(BSTiers.LIVINGMETAL, new Item.Properties().attributes(BigSwordItem.createAttributes(BSTiers.LIVINGMETAL, 6.5F, -2.8F))));
    public static DeferredItem<Item> BIOMASS_BIG_SWORD = ITEMS.register("biomass_big_sword", () -> new BigSwordItem(BSTiers.BIOMASS, new Item.Properties().attributes(BigSwordItem.createAttributes(BSTiers.BIOMASS, 6.5F, -2.8F))));
    ...
    public static DeferredItem<Item> BONE_SCYTHE = ITEMS.register("bone_scythe", () -> new ScytheItem(BSTiers.SKULL, new Item.Properties().attributes(ScytheItem.createAttributes(BSTiers.SKULL, 1, -2.0F)), 2F, 2.06F));
    ...
    public static DeferredItem<Item> GILDED_WOODEN_SHIELD = ITEMS.register("gilded_wooden_shield", () -> new TieredShield(Tiers.WOOD, new Item.Properties(), 4));
    ...
    public static DeferredItem<Item> GILDED_STONE_SHIELD = ITEMS.register("gilded_stone_shield", () -> new TieredShield(Tiers.STONE, new Item.Properties(), 2));
    public static DeferredItem<Item> IRON_SHIELD = ITEMS.register("iron_shield", () -> new TieredShield(Tiers.IRON, new Item.Properties()));
    public static DeferredItem<Item> GILDED_IRON_SHIELD = ITEMS.register("gilded_iron_shield", () -> new TieredShield(Tiers.IRON, new Item.Properties(), 1, Tiers.IRON.getUses() / 2));
    ...
    public static DeferredItem<Item> GILDED_DIAMOND_SHIELD = ITEMS.register("gilded_diamond_shield", () -> new TieredShield(Tiers.DIAMOND, new Item.Properties(), 1, -653));
    ...
    public static DeferredItem<Item> GILDED_NETHERITE_SHIELD = ITEMS.register("gilded_netherite_shield", () -> new TieredShield(Tiers.NETHERITE, new Item.Properties(), 1, -793));
    public static DeferredItem<Item> ENDER_SHIELD = ITEMS.register("ender_shield", () -> new TieredShield(BSTiers.ENDER, new Item.Properties(), 1, -(BSTiers.ENDER.getUses() / 2)));
    public static DeferredItem<Item> GILDED_ENDER_SHIELD = ITEMS.register("gilded_ender_shield", () -> new TieredShield(BSTiers.ENDER, new Item.Properties(), 1, -1190));
    public static DeferredItem<Item> QUARTZ_SHIELD = ITEMS.register("quartz_shield", () -> new TieredShield(BSTiers.QUARTZ, new Item.Properties()));
    public static DeferredItem<Item> GILDED_QUARTZ_SHIELD = ITEMS.register("gilded_quartz_shield", () -> new TieredShield(BSTiers.QUARTZ, new Item.Properties(), 2));
    public static DeferredItem<Item> PATCHWORK_SHIELD = ITEMS.register("patchwork_shield", () -> new TieredShield(BSTiers.PATCHWORK, new Item.Properties(), 2));
    public static DeferredItem<Item> GILDED_PATCHWORK_SHIELD = ITEMS.register("gilded_patchwork_shield", () -> new TieredShield(BSTiers.PATCHWORK, new Item.Properties(), 3));
    public static DeferredItem<Item> SKULL_SHIELD = ITEMS.register("skull_shield", () -> new TieredShield(BSTiers.SKULL, new Item.Properties(), 2));
    public static DeferredItem<Item> GILDED_SKULL_SHIELD = ITEMS.register("gilded_skull_shield", () -> new TieredShield(BSTiers.SKULL, new Item.Properties(), 3, BSTiers.SKULL.getUses() / 2));
    public static DeferredItem<Item> BIOMASS_SHIELD = ITEMS.register("biomass_shield", () -> new TieredShield(BSTiers.BIOMASS, new Item.Properties(), 1, BSTiers.BIOMASS.getUses() / 2));
    public static DeferredItem<Item> GILDED_BIOMASS_SHIELD = ITEMS.register("gilded_biomass_shield", () -> new TieredShield(BSTiers.BIOMASS, new Item.Properties(), 2));
    public static DeferredItem<Item> LIVINGMETAL_SHIELD = ITEMS.register("livingmetal_shield", () -> new TieredShield(BSTiers.LIVINGMETAL, new Item.Properties(), 1));
    public static DeferredItem<Item> GILDED_LIVINGMETAL_SHIELD = ITEMS.register("gilded_livingmetal_shield", () -> new TieredShield(BSTiers.LIVINGMETAL, new Item.Properties(), 2, BSTiers.LIVINGMETAL.getUses() / 2));
}
