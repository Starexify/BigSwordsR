...
public class EnderSmithingTemplate extends SmithingTemplateItem {
    ...
    private static final ResourceLocation EMPTY_SLOT_BIG_SWORD = rl("item/empty_slot_big_sword");
    private static final ResourceLocation EMPTY_SLOT_INGOT = new ResourceLocation("item/empty_slot_ingot");

    public EnderSmithingTemplate(Component pAppliesTo, Component pIngredients, Component pUpgradeDescription, Component pBaseSlotDescription, Component pAdditionsSlotDescription, List<ResourceLocation> pBaseSlotEmptyIcons, List<ResourceLocation> pAdditonalSlotEmptyIcons) {
