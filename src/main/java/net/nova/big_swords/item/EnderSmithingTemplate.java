...
public class EnderSmithingTemplate extends SmithingTemplateItem {
  ...
  public static final List<Identifier> INGREDIENT_SLOTS = new ArrayList<>(Arrays.asList(
      Identifier.parse("container/slot/helmet"),
  ...
  public static final Identifier EYE_SLOT = rl("container/slot/eye");

  public EnderSmithingTemplate(Component appliesTo, Component ingredients, Component baseSlotDescription, Component additionsSlotDescription, List<Identifier> emptyBaseSlotTextures, List<Identifier> emptyAdditionsSlotTextures, Properties properties) {
